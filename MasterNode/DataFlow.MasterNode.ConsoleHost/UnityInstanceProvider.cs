...
using AISTek.DataFlow.MasterNode.ConsoleHost.Tracing;
...
namespace AISTek.DataFlow.MasterNode.ConsoleHost
{
    ...
    internal class UnityInstanceProvider : IInstanceProvider
    {
        ...
        {
            Trace.WriteLine(string.Format("Creating instance of service {0}", serviceType), Category.Services);
            var instance = Program.Container.Resolve(serviceType);
            return instance;
        }
