...
{
    /// <summary>
    /// A WCF service behavior which sets <see cref="UnityInstanceProvider"/> as instance provider
    /// for service.
    /// </summary>
    internal class UnityServiceBehavior : IServiceBehavior
    {
        ...
        /// such as error handlers, message or parameter interceptors, security extensions, 
